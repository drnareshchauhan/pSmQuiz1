...
after setting everything above and working well on localhost run npm build
then copy paste everything from build folder to backend/src/public folder

- you cam set your own favicon `Boom`
- Deploy to heroku using git hub reposutory
  set your env in heroku using hroku config var
  add mongodb atlas key for data that is all
  it will work
